...
🎬 [Presented at Claw-Con in SF!](https://www.linkedin.com/feed/update/urn:li:activity:7425406783420047360/)
...
- **Actor-critic briefs**: Claude drafts, Codex critiques—grounded research before fixes
- **Measurable improvements**: before/after metrics on every change
...
![openclaw-trace architecture](docs/hackathon-slides/architecture.svg)

See also: `docs/architecture.md` for the ASCII version.
